...
class pdf_convocation_trainee_irspp extends ModelePDFAgefodd {
	...
	function write_file($agf, $outputlangs, $file, $session_trainee_id) {
		...
		if (file_exists($dir)) {
			...
			$this->str = ucfirst(strtolower($agf_trainee->civilitel)) . " " . $outputlangs->transnoentities($agf_trainee->prenom . ' ' . $agf_trainee->nom);
