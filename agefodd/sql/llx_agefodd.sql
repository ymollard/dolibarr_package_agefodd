...
--
-- Serveur: localhost
-- Généré le : Dim 01 Août 2010 à 18:13
...
--
-- Structure de la table `llx_agefodd_contact`
--
...
CREATE TABLE IF NOT EXISTS llx_agefodd_contact (
  ...
  PRIMARY KEY  (rowid),
  KEY idx_fx_socpeople (fk_socpeople)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

--
-- Contenu de la table llx_agefodd_contact
--

-- --------------------------------------------------------

--
-- Structure de la table llx_agefodd_convention
--
...
--
-- Structure de la table llx_agefodd_facture
--
...
--
-- Structure de la table llx_agefodd_formateur
--
...
--
-- Structure de la table llx_agefodd_formation_catalogue
--
...
CREATE TABLE IF NOT EXISTS llx_agefodd_formation_catalogue (
  ...
  ref_interne varchar(40) NOT NULL,
...
--
-- Structure de la table llx_agefodd_formation_objectifs_peda
--
...
--
-- Structure de la table llx_agefodd_reg_interieur
--
...
--
-- Contenu de la table llx_agefodd_reg_interieur
--
