...
ALTER TABLE llx_agefodd_formateur ADD COLUMN entity int(11) NOT NULL DEFAULT 1 AFTER rowid;
...
ALTER TABLE llx_agefodd_contact ADD COLUMN entity int(11) NOT NULL DEFAULT 1 AFTER rowid;
