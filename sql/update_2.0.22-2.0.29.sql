--for pgsql
UPDATE llx_agefodd_stagiaire as st SET nom=sp.name, prenom=sp.firstname, civilite=sp.civility, fk_soc=sp.fk_soc, tel1=sp.phone, 
...
prenom=sp.firstname, civilite=sp.civility, fk_soc=sp.fk_soc,tel1=sp.phone,
