ALTER TABLE llx_agefodd_session_adminsitu ADD COLUMN delais_alerte_end integer NOT NULL DEFAULT 0 AFTER delais_alerte;
...
ALTER TABLE llx_agefodd_training_admlevel MODIFY COLUMN delais_alerte_end integer NOT NULL DEFAULT 0;
-- VPGSQL8.2 ALTER TABLE llx_agefodd_training_admlevel ALTER COLUMN delais_alerte_end SET NOT NULL DEFAULT 0;

ALTER TABLE llx_agefodd_session_admlevel MODIFY COLUMN delais_alerte_end integer NOT NULL DEFAULT 0;
