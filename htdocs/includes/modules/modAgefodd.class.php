...
class modAgefodd extends DolibarrModules
{
	...
	function modAgefodd($DB)
	{
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=1',
								...
								'mainmenu'=>'agefodd',
								'url'=>'/agefodd/f_liste.php?arch=1',
								'langs'=>'@agefodd',
								'position'=>103,
								'enabled'=>1,
								'perms'=>'$user->rights->agefodd->lire',
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=9',
								...
								'mainmenu'=>'agefodd',
								'url'=>'/agefodd/u_fiche.php?action=create',
								'langs'=>'@agefodd',
								'position'=>303,
								'enabled'=>1,
								'perms'=>'$user->rights->agefodd->creer',
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=9',
								...
								'mainmenu'=>'agefodd',
								'url'=>'/agefodd/u_fiche.php?action=nfcontact',
								'langs'=>'@agefodd',
								'position'=>304,
								'enabled'=>1,
								'perms'=>'$user->rights->agefodd->creer',
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=13',
								...
								'mainmenu'=>'agefodd',
								'url'=>'/agefodd/s_teacher_liste.php',
								'langs'=>'@agefodd',
								'position'=>403,
								'enabled'=>1,
								'perms'=>'$user->rights->agefodd->lire',
