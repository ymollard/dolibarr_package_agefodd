...
if (! empty ( $id )) {
	...
	if ($result) {
		...
		if (! empty ( $socid ) && $action != 'unlink' && $action != 'createorder' && $action != 'createinvoice') {
		...
		*/
		if ($action == 'createorder') {
			...
			$form_question = array ();
			$form_question [] = array (
				'label' => $langs->trans ( "AgfCreateOrderFromPropal" ),'type' => 'radio','values' => $propal_array,'name' => 'propalid' 
			);
		...
		*/
		if ($action == 'createinvoice') {
			...
			$form_question = array ();
			$form_question [] = array (
				'label' => $langs->trans ( "AgfCreateInvoiceFromPropal" ),'type' => 'radio','values' => $propal_array,'name' => 'propalid' 
			);
			$form_question [] = array (
				'label' => $langs->trans ( "Amount" ),'type' => 'text','values' => '','name' => 'amount' 
			);
