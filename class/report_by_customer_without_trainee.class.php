 ...
 */
require_once ('agefodd_export_excel_by_customer_without_trainee.class.php');

/**
 * Class to build report by customer
 */
class ReportByCustomerWithoutTrainee extends AgefoddExportExcelByCustomerWithoutTrainee {
	private $lines;
